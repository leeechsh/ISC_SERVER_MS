...
from django.contrib.auth import (
    get_user_model, login, REDIRECT_FIELD_NAME,update_session_auth_hash,)
...
def loginView(request, template_name='registration/login.html',
    ...
    """
    return login(request,template_name,redirect_field_name,authentication_form,extra_context,redirect_authenticated_user)
