...
class UserCreationForm(forms.ModelForm):
    ...
    account_name = forms.CharField(label='Username')
    account_phone = forms.CharField(label='Phone')


    class Meta:
        model = get_user_model()
        fields = ('email','account_name','account_phone')
    ...
    def save(self, commit=True):
        ...
        user.api_hostname = Account.new_account_hostname()
        if commit:
            user.save()
        return user
